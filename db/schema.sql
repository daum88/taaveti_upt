...
-- ── SEC filed-report briefs (immutable documents + derived summaries) ─────
...
CREATE INDEX IF NOT EXISTS idx_ledger_repairs_user_time ON ledger_repairs(user_id, repaired_at DESC);
